...
# The DOCUMENTATION section is required and used by the plugin. 
DOCUMENTATION = r'''
    name: my_csv_plugin
...
class InventoryModule(BaseInventoryPlugin):
    ...
    '''
    Ansible expects the custom plugin to implement at least the parse method and recommends the verify_file method 
    as a way to validate user input. 
    '''
